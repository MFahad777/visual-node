...
<NodePreview type="array.map" height={380} width={400} />
<NodePreview type="array.filter" height={380} width={400} />
<NodePreview type="array.forEach" height={380} width={400} />
<NodePreview type="array.flatMap" height={380} width={400} />
<NodePreview type="array.find" height={380} width={400} />
<NodePreview type="array.findIndex" height={380} width={400} />
<NodePreview type="array.every" height={380} width={400} />
<NodePreview type="array.some" height={380} width={400} />
<NodePreview type="array.reduce" height={380} width={400} />
...
[Return](/node-reference/logic/return) node inside the loop body
...
<NodePreview type="array.push" height={260} width={320} />
<NodePreview type="array.pop" height={260} width={320} />
<NodePreview type="array.unshift" height={260} width={320} />
<NodePreview type="array.shift" height={260} width={320} />
<NodePreview type="array.includes" height={260} width={320} />
<NodePreview type="array.indexOf" height={260} width={320} />
...
"Result" output into a [Branch](/node-reference/control-flow) node's "Condition", for
example).

<NodePreview type="array.isArray" height={200} width={280} />

- **Inputs**: `value` (value) — "Value" (supports inline literal editing when unwired)
- **Outputs**: `result` (value) — "Result", a boolean
- **Config fields**: none
...
**Use case**: Guard logic that only makes sense for arrays — for example, branching on
whether an incoming request field is a list before running an array method on it.
