...
Defines an HTTP route and attaches a [Handler Function](/node-reference/logic/handler-function)
to it.
...
See the [Logic reference](/node-reference/logic/handler-function)
