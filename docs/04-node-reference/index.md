...
| [Logic](/node-reference/logic) | `logic.function`, `logic.export`, `logic.require`, `logic.functionCall`, `logic.pathExtractor`, `logic.graphEntry`, `logic.graphReturn`, `logic.begin`, `variable.get`, `variable.set` |
